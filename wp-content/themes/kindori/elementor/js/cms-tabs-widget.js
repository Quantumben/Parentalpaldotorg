( function( $ ) {
    ...
    $( window ).on( 'elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/cms_process.default', WidgetCMSTabsHandler );
        elementorFrontend.hooks.addAction( 'frontend/element_ready/cms_tabs_pricing.default', WidgetCMSTabsHandler );
    } );
} )( jQuery );