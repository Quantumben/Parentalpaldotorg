...
etc_add_custom_widget(
    array(
        'name' => 'cms_classes_gallery',
        'title' => esc_html__('Classes Gallery', 'kindori'),
        ...
        'params' => array(
            'sections' => array(
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_classes_gallery/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
                ...
                array(
                    'name' => 'content_list',
                    'label' => esc_html__('Classe Gallery Item', 'kindori'),
