...
etc_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Blog Carousel', 'kindori' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'show_meta',
                            'label' => esc_html__('Show Meta', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                        ),
                        array(
                            'name' => 'show_post_date',
                            'label' => esc_html__('Show Post Date', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'condition' => [
                                'show_meta' => 'true'
                        ...
                        array(
                            'name' => 'show_comment',
                            'label' => esc_html__('Show Comment', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'true',
                            'condition' => [
                                'show_meta' => 'true'
                        ...
                        array(
                            'name' => 'show_author',
                            'label' => esc_html__('Show Author', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'false',
                            'condition' => [
                                'show_meta' => 'true'
