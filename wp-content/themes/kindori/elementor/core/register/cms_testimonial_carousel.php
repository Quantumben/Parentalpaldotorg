...
etc_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Testimonial Carousel', 'kindori'),
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'wg_title',
                                    'label' => esc_html__('Emotion', 'kindori'),
                        ...
                        array(
                            'name' => 'emotion_color',
                            'label' => esc_html__('Emotion Color', 'kindori' ),
                        ...
                        array(
                            'name' => 'name_color',
                            'label' => esc_html__('Name Color', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'postion_color',
                            'label' => esc_html__('Position Color', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Border Bottom', 'kindori' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                '' => 'No Active',
                                'border-bttom-active' => 'Active',
                            ],
                            'default' => 'style1',
                        ),
                        array(
