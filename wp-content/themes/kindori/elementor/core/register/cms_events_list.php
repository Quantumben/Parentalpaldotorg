...
etc_add_custom_widget(
    array(
        'name' => 'cms_cmsevents_list',
        'title' => esc_html__('Events List Post', 'kindori' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_cmsevents_list/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
