...
etc_add_custom_widget(
    array(
        'name' => 'cms_classes_carousel',
        'title' => esc_html__('Classes Carousel', 'kindori' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_classes_carousel/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
