<?php
// Post term options
$post_term_options = etc_get_grid_term_options('cmsevents');

// Register Post Grid Widget
etc_add_custom_widget(
    array(
        'name' => 'cms_cmsevents_grid',
        'title' => esc_html__('Events Grid', 'kindori' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_cmsevents_grid/layout-image/layout1.jpg'
                                ],
                                '2' => [
                                    'label' => esc_html__('Layout 2', 'kindori' ),
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_cmsevents_grid/layout-image/layout2.jpg'
                                ],
                            ],
                        ),
                    ),
