...
?>
<div class="cms-video-player layout4 <?php echo esc_attr($cms_animate); ?>">
            ...
            <div class="box-meta">
                <?php if(!empty($settings['video_link'])) : ?>
                    <a class="btn-video" href="<?php echo esc_url($settings['video_link']); ?>">
                        ...
                        <span class="line-video-animation2 line-video-1"></span>
                        <span class="line-video-animation2 line-video-2"></span>
                        <span class="line-video-animation2 line-video-3"></span>
                    </a>
                <?php endif; ?>
