...
$show_size = $widget->get_setting('show_size');
$show_age = $widget->get_setting('show_age');
...
$load_more = array(
    ...
    'show_age' => $show_age,
    'show_size' => $show_size,
    'template_type' => 'classes_grid_layout1',
);
?>

<div id="<?php echo esc_attr($html_id) ?>" class="cms-grid cms-classes-grid layout1 <?php echo esc_attr($cms_animate); ?>" data-layout="<?php echo esc_attr($layout_type); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
