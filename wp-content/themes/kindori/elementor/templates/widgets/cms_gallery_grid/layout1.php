...
$load_more = array(
    ...
    'template_type' => 'gallery_grid_layout1',
);
?>

<div id="<?php echo esc_attr($html_id) ?>" class="cms-grid cms-gallery-grid <?php echo esc_attr($cms_animate); ?>" data-layout="<?php echo esc_attr($layout_type); ?>" data-start-page="<?php echo esc_attr($paged); ?>" data-max-pages="<?php echo esc_attr($max); ?>" data-total="<?php echo esc_attr($total); ?>" data-perpage="<?php echo esc_attr($limit); ?>" data-next-link="<?php echo esc_attr($next_link); ?>">
    ...
    <div class="<?php echo esc_attr($grid_class); ?> animation-time images-light-box" data-gutter="<?php echo esc_attr($gap_item); ?>">
