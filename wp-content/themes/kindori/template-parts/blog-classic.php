...
get_header();
$sidebar_pos = '';
$show_sidebar_page = kindori_get_page_opt( 'show_sidebar_page', false );
if ($show_sidebar_page){
    $sidebar_pos = kindori_get_page_opt( 'sidebar_page_pos' );
}
?>
<div class="container content-container">
    <div class="row content-row">
        ...
        <?php if ( 'left' == $sidebar_pos || 'right' == $sidebar_pos ) : ?>
            <aside id="secondary" <?php kindori_secondary_class( $sidebar_pos, 'sidebar-fixed widget-area' ); ?>>
