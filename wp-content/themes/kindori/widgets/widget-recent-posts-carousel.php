...
/**
 * Recent Posts Carousel widgets
 *
 * @package Kindori
 * @version 1.0
 */
class CMS_Recent_Posts_Widget_carousel extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'cms_recent_posts_carousel',
            esc_html__( '* Recent Posts Carousel', 'kindori' ),
            array(
    ...
    function widget( $args, $instance )
    {
        $instance = wp_parse_args( (array) $instance, array(
            'title'         => esc_html__( 'Recent Posts Carousel', 'kindori' ),
            'number'        => 4,
            'post_in'        => '',
        ) );

        $title = empty( $instance['title'] ) ? esc_html__( 'Recent Posts Carousel', 'kindori' ) : $instance['title'];
        ...
        if ( $r->have_posts() )
        {
            echo '<div class="posts-list owl-carousel-wrapper owl-carousel" data-item-xs="1" data-item-sm="1" data-item-md="1" data-item-lg="1" data-item-xl="1" data-item-xxl="1" data-margin="30" data-loop="true" data-autoplay="true" data-autoplaytimeout="5000" data-smartspeed="500" data-center="false" data-arrows="false" data-bullets="true" data-stagepadding="0" data-stagepaddingsm="0" data-rtl="false">';
            ...
            while ( $r->have_posts() )
            {
                ...
                echo '<div class="post-item">';
                    ...
                    $thumbnail_url = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'post-widget', false); ?>
    ...
    function form( $instance )
    {
        ...
        $title         = $instance['title'] ? esc_attr( $instance['title'] ) : esc_html__( 'Recent Posts Carousel', 'kindori' );
        $number        = absint( $instance['number'] );
...
add_action( 'widgets_init', function(){
    if(function_exists('etc_register_wp_widget')){
        etc_register_wp_widget( 'CMS_Recent_Posts_Widget_carousel' );
    }
});
